...
def get_image_dataset():
    ...
    urllib.request.urlretrieve(DATASET_URL, 'datasets/imgs/kagglecatsanddogs_3367a.zip')
...
def main():
    ...
    # Split image dataset
    split_image_dataset(os.path.join(os.getcwd(), 'datasets/imgs/PetImages/Cat'),  #Cat Source Directory
                        os.path.join(os.getcwd(), 'datasets/imgs/cats_and_dogs/train/cats'),  #Cat training destination Directory
                        os.path.join(os.getcwd(), 'datasets/imgs/cats_and_dogs/validation/cats'), #Cat testing destination Directory
                        SPLIT_SIZE)

    split_image_dataset(os.path.join(os.getcwd(), 'datasets/imgs/PetImages/Dog'),  #Dog Source Directory
                        os.path.join(os.getcwd(), 'datasets/imgs/cats_and_dogs/train/dogs'),  #Dogs training destination Directory
                        os.path.join(os.getcwd(), 'datasets/imgs/cats_and_dogs/validation/dogs'), #Dogs testing destination Directory
                        SPLIT_SIZE)
    ...
    model.add(layers.Conv2D(16, (3,3), input_shape=(IMAGE_WIDTH, IMAGE_HEIGHT, IMAGE_CHANNELS),
                                       activation=keras.activations.relu))
