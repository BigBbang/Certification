...
#I've added below encoding='utf-8' in order to overcome error: UnicodeDecodeError:
# 'charmap' codec can't decode byte 0x8f in position 2210: character maps to <undefined>
